    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <li><a class='dropdown-item' href=actualizarConsulta.php?id={$consulta['id']}>Actualizar</a></li>
                <li><a class='dropdown-item' href=eliminarConsulta.php?id={$consulta['id']}>Eliminar</a></li>
                </ul>
                </div>
                        </td>";
                        echo "</tr>";
