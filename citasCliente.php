...
if (isset($_GET['logout']) || $_SESSION['rol'] != 'Cliente') {
    session_destroy();
...
<body>
        ...
        <div class="navbar">
            <nav class="navbar__links">
                ...
                <ul>
                    ...
                    <li><a class="navbar__link--activo" href="citasCliente.php">Citas Cliente</a></li>
                </ul>
                <ul>
                    <li>
                        <a href="carrito.php">
    ...
    <script src="assets/js/obtenerCitas.js"></script>
</body>
