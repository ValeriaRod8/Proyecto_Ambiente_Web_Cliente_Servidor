...
<body>
    ...
    <div class="navbar">
            <nav class="navbar__links">
                ...
                <ul>
                    <li>
                        <a href="carrito.php">
                            <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="skyblue" class="bi bi-cart4" viewBox="0 0 16 16">
    ...
    <main class="container">
        <div class="carrito__container mb-5">
    ...
    <script type="module" src="assets/js/obtenerCarrito.js"></script>
</body>
